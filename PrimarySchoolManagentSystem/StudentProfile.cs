...
namespace PrimarySchoolManagentSystem
{
    public partial class StudentProfile : Form
    {
        ...
        public StudentProfile()
        {
            ...
            dataGridView1.Columns[5].Name = "Father's Occupaation";
            dataGridView1.Columns[6].Name = "Mother's Name";
            dataGridView1.Columns[7].Name = "Mother's Occupation";
            dataGridView1.Columns[8].Name = "Current Class";
            dataGridView1.Columns[9].Name = "Admitted in Class";
            dataGridView1.Columns[10].Name = "Roll Number";
            dataGridView1.Columns[11].Name = "Archieved Year";
        ...
        private void populate(String id,String name, string dob, string address, string fathers_name, string fathers_occupation, string mothers_name, string mothers_occupation, String current_class, String admitted_in_class, String roll_number, string archieved_year)
        {
            dataGridView1.Rows.Add(id,name,dob,address,fathers_name,fathers_occupation,mothers_name, mothers_occupation, current_class, admitted_in_class, roll_number, archieved_year);
        }
        //retirving
                ...
                try
                {
                    ...
                    foreach (DataRow row in dt.Rows)
                    {
                        //populate(row[1].ToString(), row[2].ToString(), row[3].ToString(), row[4].ToString(), row[5].ToString(), row[6].ToString(), row[7].ToString(), Convert.ToInt32(row[8].ToString()), Convert.ToInt32(row[9].ToString()), Convert.ToInt32(row[10].ToString()), row[11].ToString());
                         populate(row[0].ToString(),row[1].ToString(),row[2].ToString(),row[3].ToString(),row[4].ToString(),row[5].ToString(),row[6].ToString(),row[7].ToString(),row[8].ToString(),row[9].ToString(),row[10].ToString(),row[11].ToString());
                    }
        ...
        //updating
        public bool update(int id,String name, string dob, string address, string fathers_name, string fathers_occupation, string mothers_name, string mothers_occupation, String current_class, String admitted_in_class, String roll_number, string archieved_year)
        {
            //sql stmt

            string sql = "UPDATE student SET Name='" + name + "',DOB='" + dob + "',Address='" + address + "',Fathers_Name='" + fathers_name + "',Fathers_Occupation='" + fathers_occupation + "',Mothers_Name='" + mothers_name + "',Mothers_Occupation='" + mothers_occupation + "',CurrentClass='" + current_class + "',Admitted_in_Class='" + admitted_in_class + "',Roll_Number='" + roll_number + "',ArchievedYear='"+ archieved_year +"' WHERE ID='" + id + "'";
            cmd = new MySqlCommand(sql, con);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
           ...
           int id = Convert.ToInt32(selected);
            ...
            update( id,textBox1.Text, textBox2.Text, textBox3.Text, textBox4.Text, textBox5.Text, textBox6.Text, textBox7.Text, textBox8.Text,textBox9.Text,textBox10.Text,textBox11.Text);
